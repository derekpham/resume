...
\begin{resume}
  \newsect{\faGraduationCap\ EDUCATION}{
    \sectionunderline{
      ...
      College of Computer and Information Science} \hfill Dec. 2020\\
  ...
  \newsect{\faUsers\ EXPERIENCE}{
    \sectionunderline{
      ...
      \begin{itemize}
        {\item Created a batch post-processor tool for Yelp's data lake with Spark and AWS Glue, processing half a Terabyte per batch daily}
        {\item Greatly simplified Redshift and Athena query patterns and improved query time by more than 80\%, enabling much quicker and more accurate decision making for business analysts and data scientists}
      ...
      \begin{itemize}
        ...
        {\item Designed a Continuous Delivery framework for CSR, allowing deploying to production through 1 command}
  ...
  \newsect{\faGithubAlt\ PROJECTS}{
    \sectionunderline{
      ...
      \begin{itemize}
        ...
        {\item Powered the recommendation and storage engine using Neo4J}
      \end{itemize}
